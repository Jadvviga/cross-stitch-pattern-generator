...
<div in:fade={{ delay: 100, duration: 300 }}>
    ...
    <div class="columnContainer">
        ...
        {#if uploadedImage && uploadedFileGeneratedName}
            ...
            >
                ...
                <div class="columnContainer">
                    ...
                    />
                    <label
                        class="checkboxLabel {skipPreview ? 'disabled' : ''}"
                    >
                        <input
                            type="checkbox"
                            bind:checked={useLeastColors}
                            disabled={skipPreview}
                        />
        ...
        {:else}
            <p class="note">
                note: Your image MUST be CLEAR PIXEL ART (1 square on image = 1
                pixel).<br />Otherwise a proper output is not guaranteed.
            </p>
        {/if}
